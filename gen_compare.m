...
% Last Modified by GUIDE v2.5 03-Jul-2019 16:33:15
...
for k = 1:out
   disp(k)
filename=strcat('temp',num2str(k));
location=['E:\New folder\test\Templates\',filename,'.bmp'];
temp2=imread(strcat(location));
DecImg = imageProcess(temp2,key);
hd=hammingdist(temp1, DecImg);
disp(hd)
